...
namespace pz_10
{
    class Program
    {
        ...
        {
            string[][] cstrs = new string[5][];// объевлена массивов
            string[] last_elems_of_cstrs = new string[5]; //последний элемент
            string[] max_strs = new string[5];// максимальная значение  
            string[] max_str_of_length = new string[5]; // максимальное длина 
            Random rnd = new Random();// объевления рандома 

            for (int i = 0; i < 5; i++)
            {

                cstrs[i] = new string[rnd.Next(2, 25)];
                ...
                Console.WriteLine();
                Console.WriteLine("Последний элемент:  " + last_elems_of_cstrs[i]);
                Console.WriteLine("Максимальный элемент:  " + max_strs[i]);
                Console.WriteLine("максимальная длина:  " + max_str_of_length[i]);
